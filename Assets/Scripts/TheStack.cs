...
public class TheStack : MonoBehaviour
{
    ...
    private const int COMBO_STACK_GAIN = 3;
            ...
            if (Mathf.Abs(deltaZ) > ERROR_MARGIN)
            {
                ...
                CreateRubble
                    (
                        ...
                        new Vector3(t.localPosition.x, 1, Mathf.Abs(deltaZ))
                    );
    ...
    public void OnButtonClic(string sceneName)
    {
